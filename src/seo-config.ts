// Configuración de SEO para el sitio
export const seoConfig = {
  ...
  type: 'website',
  analytics: {
    // Configuración de Google Analytics (si lo usas)
  ...
  contactPoint: {
    email: 'gracia123ramon@hotmail.com',
    telephone: '+52 667 121 0309',
    contactType: 'customer service'
  },
  // Información de la organización para schema.org
  organization: {
    name: 'Ramón Gracia',
    logo: '/images/ramon-gracia-preview.jpg'
  }
};
